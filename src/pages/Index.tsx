      ...
      <section id="about" className="py-24 md:py-32 px-6 lg:px-12">
        <div className="max-w-6xl mx-auto grid md:grid-cols-12 gap-12">
          ...
          <Reveal delay={150} className="md:col-span-7 space-y-5 text-base md:text-lg leading-relaxed text-espresso/85">
            <p>
              <span className="font-serif italic text-xl text-gold">Nontokozo Hlengwa Mkhize</span> (Inanda, KwaZulu-Natal) is a South African Afro-soul and gospel singer-songwriter. She began her musical journey in 2017 as a backing vocalist, working alongside Benjamin Dube, Mondli Ngcobo, Naima Kay, Dumi Mkokstad, and Sjava.
            </p>
            <p>
